...
| T6  | Local malware reading identity / messages | `$HERMOD_HOME/identity/ed25519_secret` saved with mode 0600. SQLite DB inherits user perms. `WorkspaceSecret` and `ChannelMacKey` zeroize on drop. |
